...
public final class LoggerFactory {
	...
	private final static void performInitialization() {// 进行工厂的初始化
        bind();
	...
	private final static void bind() {// 绑定到指定的实现中
        try {
    ...
    public static Logger getLogger(String name) {
		ILoggerFactory iLoggerFactory = getILoggerFactory();// 实现类???
	...
	public static ILoggerFactory getILoggerFactory() {// 获取工厂
