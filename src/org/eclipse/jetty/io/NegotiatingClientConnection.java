...
public abstract class NegotiatingClientConnection extends AbstractConnection {
	...
	// *******************************************************************
	protected NegotiatingClientConnection(EndPoint endp, Executor executor, SSLEngine sslEngine,
			ClientConnectionFactory connectionFactory, Map<String, Object> context) {
        super(endp, executor);
