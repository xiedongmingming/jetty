...
public class HelloServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// System.out.println("测试是否是单利类: " +
		// this.getServletContext().getClass().hashCode());
		// System.out.println(request.getServerName() + request.getRequestURI()
		// + request.getQueryString());
		// System.out.println("测试是否是单利类: " + this.hashCode());
		// System.out.println("测试是否是单利类: " +
		// this.getServletConfig().getClass().getCanonicalName());
		// System.out.println("测试是否是单利类: " +
		// this.getServletConfig().getServletContext().getClass().getCanonicalName());
