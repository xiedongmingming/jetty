...
public class StatisticsServlet extends HttpServlet {
    ...
    @Override
	public void init() throws ServletException {// javax.servlet.GenericServlet#init()
    ...
    @Override
	public void doPost(HttpServletRequest sreq, HttpServletResponse sres) throws ServletException, IOException {//javax.servlet.http.HttpServlet#doPost(javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse)
        doGet(sreq, sres);
    }
    @Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {//javax.servlet.http.HttpServlet#doGet(javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse)
