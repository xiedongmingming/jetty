...
public class SessionHandler extends ScopedHandler {
    ...
    public static final Class<? extends EventListener>[] SESSION_LISTENER_TYPES = 
			new Class[] { HttpSessionAttributeListener.class, HttpSessionIdListener.class, HttpSessionListener.class };
	...
	public void doScope(String target, Request baseRequest, HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (_sessionManager != null) {
				...
				if (session != null) {
					if ((session != old_session) && (request.getDispatcherType() == DispatcherType.ASYNC
