 ...
 */
public class SecureRequestCustomizer implements HttpConfiguration.Customizer {// 定制器(针对SECURE)
	...
	private void formatSTS() {
		if (_stsMaxAge < 0) {
			...
			_stsField = new PreEncodedHttpField(HttpHeader.STRICT_TRANSPORT_SECURITY,
					String.format("max-age=%d%s", _stsMaxAge, _stsIncludeSubDomains ? "; includeSubDomains" : ""));
		}
    }
