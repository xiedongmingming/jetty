...
public class GzipHttpOutputInterceptor implements HttpOutput.Interceptor {
	...
	public GzipHttpOutputInterceptor(GzipFactory factory, HttpField vary, HttpChannel channel,
	...
	public GzipHttpOutputInterceptor(GzipFactory factory, HttpField vary, int bufferSize, HttpChannel channel,
			HttpOutput.Interceptor next, boolean syncFlush) {
        _factory=factory;
        _channel=channel;
        _interceptor=next;
	...
	public static void main(String[] args) {
		...
		try {
			...
			String inputString = "blahblahblahasdfasdfasdfasdfsdfgsdfasdfasdfadsfadsf";
