...
public class HttpChannelState {
	...
	public enum State {// the dispatched state of the HttpChannel, used to control the overall lifecycle
        IDLE,             // Idle request
	...
	public enum Action {// the actions to take as the channel moves from state  to state.
	...
	private final HttpChannel _channel;// 所在的通道

    private List<AsyncListener> _asyncListeners;
	private State _state;// 初始装填
	private Async _async;// 异步
	private boolean _initial;// 初始化(初始值为真)
	...
	protected Action handling() {// next handling of the request should proceed
		if (DEBUG) {
	...
	protected Action unhandle() {
		...
		// * @return next actions
		// * be handled again (eg because of a resume that happened before
		// unhandle was called)
		// */
