...
public class HttpField {// 表示一个HTTP域

	private final static String __zeroquality = "q=0";
	private final HttpHeader _header;// 域
	private final String _name;// 域的名称字符串
	private final String _value;// 域的值
	private int hash = 0;
    ...
    public String[] getValues() {
		...
		for (int i = 0; i < _value.length(); i++) {// 逐个字符处理
