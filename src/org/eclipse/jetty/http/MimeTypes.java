...
public class MimeTypes {
	...
	public enum Type {// 表示一种类型: content-type
		...
		private final String _string;// 内容类型字符串
		private final ByteBuffer _buffer;// 对应内容类型字符串
		private final Type _base;// 自身或者指定
        private final Charset _charset;
		private final String _charsetString;// 编码
		private final boolean _assumedCharset;// 是否指定了编码方式(构造函数中)
