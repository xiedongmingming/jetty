...
public class DateGenerator {// "EEE, dd MMM yyyy HH:mm:ss 'GMT'"
	...
	private static final ThreadLocal<DateGenerator> __dateGenerator = new ThreadLocal<DateGenerator>() {// 每个线程都会有一个
        @Override
	...
	public static String formatDate(long date) {// 参数为毫秒数
		return __dateGenerator.get().doFormatDate(date);
    }
    public static void formatCookieDate(StringBuilder buf, long date) {// 参数为毫秒数
